...
function handleApperanceChange(){
    <style>
        ...
        <>
            <div className="calculator-container">
                <div className="apperance-container">
                 <span className="dark-apperance" onClick={handleApperanceChange} >d</span>
                 <span className="light-apperance ">l</span>
                </div>
                ...
                <div className="button-container">
                    ...
                    <button onClick={deleteLast}>b</button>
